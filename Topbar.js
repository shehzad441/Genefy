...
export default function Topbar() {
  ...
  return (
    <div className="w-full bg-gradient-to-b from-[#e9efff] to-white text-gray-900"
    >
      {/* Top Bar */}
      ...
      <div className="flex justify-between items-center py-8 px-10">
        ...
        <Link href="/login" className='bg-[#6454D6] text-white py-3 px-8 rounded-full hover:bg-[#5a2b9e] transition-colors'>
          Log In</Link>
      </div>
    </div>
  );
